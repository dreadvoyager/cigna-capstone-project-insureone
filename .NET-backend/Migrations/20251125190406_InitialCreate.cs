    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    POLICYID = table.Column<long>(type: "NUMBER(19)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    USERID = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    INSURER = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    POLICYTYPE = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    PREMIUMAMT = table.Column<decimal>(type: "DECIMAL(18, 2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CLAIMID = table.Column<long>(type: "NUMBER(19)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    POLICYID = table.Column<long>(type: "NUMBER(19)", nullable: false),
                    USERID = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    CLAIMAMT = table.Column<decimal>(type: "DECIMAL(18, 2)", nullable: false),
